      ...
      <div className='grid sm:grid-cols-[2fr,1.3fr] h-screen'>
        ...
        <div className='flex flex-col items-center justify-center mx-8 my-8'>
          <div className='w-2/3 grid gap-7'>
            <div className='text-3xl font-bold'>Fill your complete password</div>
            <div className='font-thin'>set your new password</div>
            <form className='flex flex-col items-center w-full gap-4'>
              ...
              <div className='w-full'>
                <label htmlFor='confirmPassword' className='block text-md font-medium leading-10'>
                  Confirm Password
                </label>
                <input
                  type='password'
