        ...
        <div className='w-2/5 flex flex-col gap-5'>
          ...
          <div className='bg-white rounded-lg flex flex-col px-10 gap-4'>
            ...
            <div className='grid gap-4'>
              <div className='flex justify-between'>
                <div className='text-base font-normal'>Movie Selected</div>
                <div className='font-semibold'>Spider-Man: Homecoming</div>
              </div>
              <div className='flex justify-between'>
                <div className='text-base font-normal'>Tuesday, 07 July 2020</div>
                <div className='font-semibold'>02:00</div>
              </div>
              <div className='flex justify-between'>
                <div className='text-base font-normal'>One ticket price</div>
                <div className='font-semibold'>$10</div>
              </div>
              <div className='flex justify-between'>
                <div className='text-base font-normal'>Seat choosed</div>
